...
```
cd existing_repo
git remote add origin https://gitlab.com/clannzu2/camlin-task.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/clannzu2/camlin-task/-/settings/integrations)
